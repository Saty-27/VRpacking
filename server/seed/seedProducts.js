...
const products = [
  { name: 'HDPE Roll', slug: 'hdpe-roll-supplier', cat: 'Industrial Bags', short: 'High-density polyethylene rolls for industrial wrapping and packaging applications.', features: ['High tensile strength', 'Moisture resistant', 'Chemical resistant', 'UV stabilized options'], applications: ['Cargo wrapping', 'Industrial lining', 'Construction', 'Agriculture'] },
  { name: 'Aluminium Barrier Foil Rolls', slug: 'aluminium-barrier-foil-rolls', cat: 'Barrier Foils', short: 'Premium aluminium barrier foil rolls providing superior moisture and corrosion protection for export cargo.', features: ['Multi-layer lamination', 'Excellent moisture barrier', 'Corrosion protection', 'Heat sealable'], applications: ['Export packaging', 'Metal component protection', 'Defence equipment', 'Marine cargo'] },
  { name: 'VCI Film Roll', slug: 'vci-film-roll', cat: 'VCI Products', short: 'Volatile Corrosion Inhibitor film rolls for long-term metal protection during storage and transit.', features: ['Multi-metal protection', 'Transparent film', 'Self-activating VCI', 'Long shelf life'], applications: ['Automotive parts', 'Machine components', 'Steel coils', 'Precision instruments'] },
  { name: 'Humidity Indicator', slug: 'humidity-indicator-card', cat: 'VCI Products', short: 'Humidity indicator cards and plugs for monitoring moisture levels inside sealed packages.', features: ['Accurate readings', 'Color-changing dots', 'Multiple RH levels', 'Industry standard'], applications: ['Export packaging', 'Electronics', 'Military equipment', 'Pharmaceutical'] },
  { name: 'Thermo Shrink Packing', slug: 'thermo-shrink-packing', cat: 'Shrink Films', short: 'Professional thermo shrink packing solutions for heavy machinery and industrial equipment.', features: ['Tight conforming wrap', 'Weather protection', 'Tamper evident', 'Custom sizing'], applications: ['Heavy machinery', 'ODC cargo', 'Project cargo', 'Marine export'] },
  { name: 'Aluminium Foil Packing for Preservation', slug: 'aluminium-foil-packing-for-preservation', cat: 'Barrier Foils', short: 'Specialized aluminium foil packing for long-term preservation of sensitive components.', features: ['Oxygen barrier', 'Light barrier', 'Desiccant compatible', 'Vacuum sealable'], applications: ['Defence equipment', 'Aerospace parts', 'Electronics', 'Medical devices'] },
  { name: 'Heavy Duty Protective Cover', slug: 'heavy-duty-protective-cover', cat: 'Protective Covers', short: 'Industrial-grade heavy duty covers for protecting machinery and equipment during transit.', features: ['Tear resistant', 'Waterproof', 'UV protected', 'Custom fabrication'], applications: ['Machinery export', 'Outdoor storage', 'Construction sites', 'Warehousing'] },
  { name: 'Silpaulin Cover', slug: 'silpaulin-cover', cat: 'Protective Covers', short: 'Premium silpaulin covers for weather protection of cargo and industrial equipment.', features: ['Waterproof', 'High durability', 'Reinforced edges', 'Multiple color options'], applications: ['Cargo protection', 'Agriculture', 'Construction', 'Truck covers'] },
  { name: 'LD/HM Liners', slug: 'ld-hm-liners', cat: 'Industrial Bags', short: 'Low-density and high-molecular liners for container and drum lining applications.', features: ['Food grade options', 'Leak proof', 'Custom sizes', 'Anti-static options'], applications: ['Container lining', 'Drum lining', 'Bulk packaging', 'Chemical storage'] },
  { name: 'LDPE Shrink Film', slug: 'ldpe-shrink-film', cat: 'Shrink Films', short: 'Low-density polyethylene shrink film for versatile packaging and bundling applications.', features: ['High clarity', 'Strong shrink force', 'Consistent gauge', 'Recyclable'], applications: ['Product bundling', 'Pallet wrapping', 'Gift packaging', 'Industrial wrapping'] },
  { name: 'Disposable Aprons', slug: 'disposable-aprons', cat: 'Industrial Bags', short: 'Disposable polyethylene aprons for industrial and food processing applications.', features: ['Lightweight', 'Waterproof', 'Hygienic', 'Cost effective'], applications: ['Food processing', 'Chemical handling', 'Medical use', 'Industrial cleaning'] },
  { name: 'Carry Bags', slug: 'carry-bags-manufacturer', cat: 'Industrial Bags', short: 'Industrial carry bags in various sizes and thicknesses for packaging needs.', features: ['Multiple sizes', 'Custom printing', 'Durable material', 'Eco-friendly options'], applications: ['Retail packaging', 'Industrial use', 'Grocery', 'E-commerce'] },
  { name: 'PP Tubing', slug: 'pp-tubing', cat: 'Industrial Bags', short: 'Polypropylene tubing for specialized industrial packaging requirements.', features: ['High clarity', 'Strong seal strength', 'Custom widths', 'FDA compliant options'], applications: ['Product packaging', 'Industrial components', 'Textile packaging', 'Hardware packaging'] },
  { name: 'Heavy Duty Liner Bags', slug: 'heavy-duty-liner-bags', cat: 'Industrial Bags', short: 'Extra-strong liner bags for heavy industrial packaging and bulk material storage.', features: ['Puncture resistant', 'Heavy gauge', 'Gusseted options', 'Custom dimensions'], applications: ['Bulk chemicals', 'Mining', 'Construction materials', 'Heavy components'] },
  { name: 'Perforation / Embossing Bags', slug: 'perforation-embossing-bags', cat: 'Industrial Bags', short: 'Perforated and embossed bags for specialized ventilation and grip requirements.', features: ['Micro perforation', 'Anti-slip embossing', 'Breathable design', 'Custom patterns'], applications: ['Fresh produce', 'Bakery', 'Industrial parts', 'Agricultural'] },
  { name: 'Valve Type LD Bags', slug: 'valve-type-ld-bags', cat: 'Industrial Bags', short: 'Valve-type low-density bags for easy filling and efficient sealing of bulk materials.', features: ['Self-closing valve', 'Easy filling', 'Dust-free', 'Stackable'], applications: ['Powders', 'Granules', 'Cement', 'Chemical compounds'] },
  { name: 'Desiccants', slug: 'desiccant-bags', cat: 'VCI Products', short: 'Industrial desiccants for moisture absorption inside packaging.', features: ['High absorption', 'Non-toxic', 'Indicating type', 'Multiple sizes'], applications: ['Export packaging', 'Electronics', 'Pharmaceuticals', 'Metal parts'] },
  { name: 'Tarpaulin Rolls', slug: 'tarpaulin-rolls', cat: 'Protective Covers', short: 'Heavy-duty tarpaulin rolls for outdoor coverage and protection.', features: ['UV resistant', 'Waterproof', 'Tear resistant', 'Grommeted'], applications: ['Truck covers', 'Warehouse protection', 'Outdoor storage', 'Construction'] },
  { name: 'ODC Cargo Packing', slug: 'odc-cargo-packing-materials', cat: 'Protective Covers', short: 'Over-dimensional cargo packing solutions for project cargo and heavy machinery.', features: ['Custom engineered', 'Multi-layer protection', 'Corrosion prevention', 'Transport ready'], applications: ['Heavy machinery', 'Power plant equipment', 'Oil & gas', 'Defence'] },
  { name: 'Seaworthy Packing', slug: 'seaworthy-wooden-box-packing', cat: 'VCI Products', short: 'Complete seaworthy packaging solutions compliant with international export standards.', features: ['ISPM-15 compliant', 'Moisture protection', 'Corrosion prevention', 'Custom design'], applications: ['Sea freight', 'International export', 'Heavy equipment', 'Automotive'] },
  { name: 'VCI Paper', slug: 'vci-paper-supplier', cat: 'VCI Products', short: 'Premium Volatile Corrosion Inhibitor paper sheets and rolls for wrapping metal components.', features: ['Clean rust prevention', 'Recyclable packaging', 'Multi-metal protection', 'Easy custom cutting'], applications: ['Bearings', 'Precision components', 'Hand tools', 'Spare parts'] },
  { name: 'VCI Bags', slug: 'vci-bags-manufacturer', cat: 'VCI Products', short: 'Custom-made Volatile Corrosion Inhibitor bags for storing and transporting metal components.', features: ['Puncture resistant', 'Airtight sealing options', 'Active rust prevention', 'Custom size options'], applications: ['Electronic housings', 'Auto spare parts', 'Military assemblies', 'Fasteners'] },
  { name: 'VCI Oil', slug: 'vci-oil-supplier', cat: 'VCI Products', short: 'Specialized corrosion-inhibitor liquid and oil for passivating metal surfaces during storage.', features: ['Self-healing film', 'Water displacement', 'Easy spray/dip application', 'Long-term rust defense'], applications: ['Engine blocks', 'Internal pipe surfaces', 'Machinery gears', 'Metal castings'] },
];
...
const imageMap = {
  ...
  'VCI Paper': '/uploads/vci_paper.png',
  'VCI Bags': '/uploads/vci_bags.png',
  'VCI Oil': '/uploads/vci_oil.png',
};
