...
export default function PrivacyPolicy() {
  return (<>
    ...
    <section className="section"><div className="container" style={{maxWidth:800,margin:'0 auto'}}>
      <h2>Privacy Policy</h2><p style={{color:'var(--grey)',marginTop:16,lineHeight:1.8}}>VR Packaging Solutions ("us", "we", or "our") operates the vrpack.co.in website. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our website.</p>
